...
function endGame() {
  ...
  let msg;
  if(finalScore < 33) msg = "Rank C: NOOB GAMEPLAY - Keep practicing! You can do it! Practice is the key!";
  if(finalScore >= 33 && finalScore < 66) msg = "Rank B: You are a true Zombie Hunter!";
  if(finalScore >= 66 && finalScore < 99) msg = "Rank A: PRO GAMEPLAY - You are a true Zombie Hunter!";
  if(finalScore === 100) msg= "Rank S: Apocalypse Conqueror - We will need you when the Zombie Apocalypse comes!"; // Assuming you have an element with id="myText"

//   container.innerHTML = `
//   <div class="container-collect-cgun">
//     <h2 style="color:white">${msg}</h2>
//     <button id="play_again" onclick="play-again()">PLAY AGAIN</button>
//   </div>
//  `;
...
//   if(collectCgunBtn.textContent === "GRATS! PLAY AGAIN!") {
...
//   collectCgunBtn.textContent = "GRATS! PLAY AGAIN!";
//   moneySound.play();
//   setTimeout(() => {
...
function shoot(e) {
  if(canShoot) {
    ...
    if (e.target === zombie) {
      ...
      // else render the incre  mented score
      else {
        scoreElementNum.innerHTML = `${score} / ${maxScore}`;
      }
    }
...
/* CROSSHAIR CURSOR TRACKER  OR CURSOR MOVEMENTS*/
